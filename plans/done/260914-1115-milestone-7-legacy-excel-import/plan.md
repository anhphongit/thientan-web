...
| Phase | Name | Status |
|-------|------|--------|
| 1 | [Ingestion and Dry-Run Parsing](./phase-01-ingestion-and-dry-run-parsing.md) | Complete (2026-09-17) |
| 2 | [Field Mapping and Extraction Rules](./phase-02-field-mapping-and-extraction-rules.md) | Complete (2026-09-17) |
| 3 | [Bulk Write Path](./phase-03-bulk-write-path.md) | Complete (2026-09-17) |
| 4 | [Idempotency and Resumability](./phase-04-idempotency-and-resumability.md) | Complete (2026-09-17) |
| 5 | [Reconciliation, Live Run and Docs Sync](./phase-05-reconciliation-live-run-and-docs-sync.md) | Complete (2026-09-17) |
