...
#### 0. UI Design (for new UI screens/components)
**Mock-first approach (Issue M5-3, 2026-09-10):**
- For any new UI screen or major component, create mock/template HTML options BEFORE implementation
- Generate 2-3 design approaches showing different layouts, styles, or interaction patterns
- Present mockups to user for review and approval
- User selects preferred option, provides design feedback
- Only then proceed with actual implementation
- This prevents rework and ensures design decisions are validated upfront
- For: new pages, forms, permission matrix editors, config panels, significant redesigns
- Skip for: bug fixes, minor tweaks, style refinements to existing components
