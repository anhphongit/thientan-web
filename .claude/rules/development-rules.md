...
## UI Design Process
**All new UI components must follow the mock-first approach (Issue M5-3, 2026-09-10):**
- Before writing actual HTML/CSS/JS for any new UI screen or major component, create 2-3 **mock/template HTML options** showing different design approaches
- Present mock options to the user for review and selection BEFORE implementation
- User reviews mockups, picks preferred layout/style, and gives approval
- ONLY THEN proceed with actual implementation
- This ensures design decisions are validated upfront, preventing rework after code is written
- Mock options should be minimal but complete enough to evaluate UX, layout, and visual hierarchy
- Use this for: new pages, significant form redesigns, new components, permission matrix editors, config panels, etc.
- Skip for: minor tweaks, style refinements to existing components, bug fixes (focus on function)
